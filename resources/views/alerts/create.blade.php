                    ...
                    <form action="{{ route('alerts.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="notification_channel_email" name="notification_channels[]" value="email" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" checked>
                                    <label for="notification_channel_email" class="ml-2 block text-sm text-gray-700">Email</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="notification_channel_slack" name="notification_channels[]" value="slack" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" name="conditions[]" value="sentiment_positive" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <label class="ml-2 text-sm text-gray-700">Positive Sentiment</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" name="conditions[]" value="sentiment_negative" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <label class="ml-2 text-sm text-gray-700">Negative Sentiment</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" name="conditions[]" value="has_media" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <label class="ml-2 text-sm text-gray-700">Contains Media</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" name="conditions[]" value="is_reply" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
